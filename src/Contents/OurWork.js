...
const OurWork = () => {
  ...
  const className = {
    container:
      "w-screen h-fit lg:h-screenLg relative overflow-hidden py-20 lg:py-14 px-6",
    image: "w-auto h-full right-0 absolute top-0 -z-20",
    innerContainer: "h-screen space-y-10",
    titleContainer:
      "w-full h-fit flex-col space-y-4 text-center items-center lg:flex-row lg:text-start flex lg:justify-between font-hindVadodara",
    title: "text-4xl z-20",
    titleLine1: "font-bold",
    titleLine3: "w-16 h-6 relative",
    titleLine3Underline:
      "w-full h-2 bg-yellow-400 absolute top-9 inset-x-0 -z-10",
    description: "w-[400px] lg:w-[500px]",
    ...
    cardDesktopImage: "h-40 w-52 md:h-60 md:w-72",
    cardMobileImage: "h-40 w-14 md:h-60 md:w-24",
  ...
  return (
    <div id="OurWork" className={className.container}>
      <img
        src={background}
        className={className.image}
        alt="a graphicated background"
      />
      <div className={className.innerContainer}>
        <div className={className.titleContainer}>
          <h1 className={className.title}>
            <span className={className.titleLine1}>Our Recent Work </span>
            <br /> By Our{" "}
            <span className={className.titleLine3}>
              Experts <div className={className.titleLine3Underline} />
            </span>
          </h1>
              ...
              >
                <div className={className.cardContainer}>
                  <div className={className.cardImagesContainer}>
                    <img
                      className={className.cardDesktopImage}
                      src={data.desktopImage}
                      alt="Desktop design example"
                    />
                    <img
                      className={className.cardMobileImage}
