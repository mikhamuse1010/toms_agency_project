...
const WWD = () => {
    ...
    const className = {
        ...
        image: "w-full h-full -z-20 absolute top-0",
    ...
    return (
        <div id='WWD' className={className.container}>
            <img src={WwdImage} className={className.image} alt='a graphic with a lot of elements' />
            <div className={className.innerContainer}>
                <div className={className.titleContainer}>
                    <h1 className={className.title}>
                        <span className={className.titleLine1}>What We Do </span><br /> For Your <span className={className.titleLine3}>Business <div className={className.titleLine3Underline} /></span>
                    </h1>
                </div>
                ...
                <Carousel show={3}>
                    {
                        Carousel1Data.map((data, index) => {
                            return (
                                <div data-aos="fade-down" className={className.cardOuterContainer} key={index}>
                                    <div className={className.cardContainer}>
                                        <div className={`${data.iconsBG} ${className.cardIconContainer}`}>
                                            {data.Icons}
                                        </div>
